...
radius0 = st.sidebar.slider("Radius 0", 7.0, 29.0, 15.0, 0.1)
texture0 = st.sidebar.slider("Texture 0", 9.8, 40.0, 20.0, 0.1)
smoothness0 = st.sidebar.slider("Smoothness 0", 0.06, 0.17, 0.09, 0.1)
concave_points0 = st.sidebar.slider("Concave points 0", 0.0, 0.20, 0.04, 0.1)
symmetry0 = st.sidebar.slider("Symmetry 0", 0.2, 0.31, 0.19, 0.1)
fractal_dimension0 = st.sidebar.slider("Fractal dimension 0", 0.05, 0.98, 0.06, 0.1)
...
smoothness1 = st.sidebar.slider("Smoothness 1", 0.002, 0.032, 0.007, 0.1)
concave_points1 = st.sidebar.slider("Concave points 1", 0.0, 0.053, 0.01, 0.1)
symmetry1 = st.sidebar.slider("Symmetry 1", 0.008, 0.079, 0.020, 0.1)
fractal_dimension1 = st.sidebar.slider("Fractal dimension 1", 0.0009, 0.030, 0.003, 0.1)

st.sidebar.write("### Parâmetros 2")

radius2 = st.sidebar.slider("Radius 2", 8.0, 37.0, 17.0, 0.1)
texture2 = st.sidebar.slider("Texture 2", 13.0, 50.0, 27.0, 0.1)
smoothness2 = st.sidebar.slider("Smoothness 2", 0.08, 0.23, 0.014, 0.1)
concave_points2 = st.sidebar.slider("Concave points 2", 0.0, 0.30, 0.012, 0.1)
symmetry2 = st.sidebar.slider("Symmetry 2", 0.2, 0.67, 0.30, 0.1)
fractal_dimension2 = st.sidebar.slider("Fractal dimension 2", 0.06, 0.21, 0.09, 0.1)
