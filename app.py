...
concave_points0 = st.sidebar.slider("Concave points 0", 0.0, 0.20, 0.1)
symmetry0 = st.sidebar.slider("Symmetry 0", 0.2, 0.31, 0.1)
fractal_dimension0 = st.sidebar.slider("Fractal dimension 0", 0.05, 0.98, 0.1)

st.sidebar.write("### Parâmetros 1")

radius1 = st.sidebar.slider("Radius 1", 0.2, 2.9, 0.1)
