...
smoothness0 = st.sidebar.slider("Smoothness", 0.052630, 0.16340, 0.13, 0.1)
concave_points0 = st.sidebar.slider("Concave points", 0.0, 0.20120, 0.10, 0.1)
...
smoothness1 = st.sidebar.slider("Smoothness", 0.001713, 0.03113, 0.031, 0.1)
concave_points1 = st.sidebar.slider("Concave points", 0.0, 0.05279, 0.04, 0.1)
symmetry1 = st.sidebar.slider("Symmetry", 0.007882, 0.07895, 0.05, 0.1)
fractal_dimension1 = st.sidebar.slider("Fractal dimension", 0.000895, 0.02984, 0.029, 0.1)
