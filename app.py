...
smoothness0 = st.sidebar.slider("Smoothness 0", 0.06, 0.17, 0.09, 0.01)
concave_points0 = st.sidebar.slider("Concave points 0", 0.0, 0.20, 0.04, 0.01)
symmetry0 = st.sidebar.slider("Symmetry 0", 0.2, 0.31, 0.19, 0.01)
fractal_dimension0 = st.sidebar.slider("Fractal dimension 0", 0.05, 0.98, 0.06, 0.01)
...
fractal_dimension1 = st.sidebar.slider("Fractal dimension 1", 0.0009, 0.030, 0.003, 0.001)
...
smoothness2 = st.sidebar.slider("Smoothness 2", 0.08, 0.23, 0.014, 0.01)
concave_points2 = st.sidebar.slider("Concave points 2", 0.0, 0.30, 0.012, 0.01)
symmetry2 = st.sidebar.slider("Symmetry 2", 0.2, 0.67, 0.30, 0.01)
fractal_dimension2 = st.sidebar.slider("Fractal dimension 2", 0.06, 0.21, 0.09, 0.01)
